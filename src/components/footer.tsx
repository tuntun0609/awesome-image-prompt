        ...
        <div className="mt-12 flex flex-wrap items-end justify-between gap-6 border-t py-6">
          ...
          <div className="order-first flex flex-wrap justify-center gap-6 text-sm md:order-last">
            <Link
              ...
              className="text-muted-foreground block hover:text-[#000000]"
            >
              <svg
                className="size-6"
            ...
            <Link
              ...
              rel="noopener noreferrer"
              aria-label="Bilibili"
              className="text-muted-foreground block hover:text-[#FF6699]"
            >
              <svg
                className="size-6"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <Link
              href="https://juejin.cn/user/246741568859165"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Juejin"
              className="text-muted-foreground block hover:text-[#006CFF]"
            >
              <svg
                className="size-6"
                xmlns="http://www.w3.org/2000/svg"
